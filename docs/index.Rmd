---
title: "Los 1000 streamers más populares de Twitch del 2020"
...
```{r,echo=FALSE,include=TRUE,fig.height=10,fig.width=14}
...
##### PromEspectadores tiene un R2 mas alto
```{r}
...
##### PromEspectadores tiene un R2 mas alto, sacamos Auspiciadores por no ser significativa
```{r}
#
